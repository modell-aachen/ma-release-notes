...
* Behalten Sie auch bei einer Vielzahl von Aufgaben den Überblick, was wann durch wen zu erledigen ist. Aufgabenübersichten wurden um weitere Filterfunktionen ergänzt. Zusätzlich wurde die Standardfilterung auf offene Aufgaben eingeschränkt.
...
* Unsere Loginmaske bekommt ein modernes Design und wird bei Anbindung an eine Nutzerverwaltung (z.B. Azure AD) nun in der korrekten Reihenfolge angezeigt: Als erstes der Unternehmenslogin und dann der Login mit Benutzername sowie Passwort. Sie haben noch keine Microsoft Azure AD Anbindung? Dann schauen Sie in unsere [Detailinformation und Anleitung zur Microsoft Azure AD Anbindung](https://releases.modell-aachen.de/faq/microsoft-azure-ad.html)!
